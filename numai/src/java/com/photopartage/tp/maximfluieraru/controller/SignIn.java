...
public class SignIn extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id = (String) request.getParameter("id_in").trim();
        String password_in = (String) request.getParameter("password_in").trim();
        password_in = HelperContext.encryptSha1(password_in);
      
        Page page;

        UserDAO userDao = new UserDAO();
        User user = new User(id, password_in);
